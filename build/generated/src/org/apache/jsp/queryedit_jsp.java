...
public final class queryedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            st.executeUpdate("update produk set set kd_produk='"+kodeproduk+"',nm_produk='"+nama+"',harga_produk='"+harga+"',qty='"+qty+"' where id_produk='"+kode+"'");
